...
resource "azurerm_container_app_environment" "eraki_container_environment" {
  ...
  # infrastructure_resource_group_name = azurerm_resource_group.pepco_foundation_we_rg.name
  # infrastructure_subnet_id   = azurerm_subnet.pepco_foun_netspoke_we_subnet_containerApp.id
...
resource "azurerm_container_app_environment_storage" "eraki_container_env_storage" {
  name                         = var.storage_account_name  # azurerm_storage_account.pepco_shared_storageaccount.name
  ...
  access_key                   = var.share_storage_account_primary_access_key  # azurerm_storage_account.pepco_shared_storageaccount.primary_access_key
